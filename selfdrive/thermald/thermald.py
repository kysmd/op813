...
def check_car_battery_voltage(should_start, pandaStates, charging_disabled, msg):
  ...
  if charging_disabled and (pandaStates is None or peripheralState.voltage > (int(kegman_kans.conf['carVoltageMinEonShutdown'])+500)) and msg.deviceState.batteryPercent < int(kegman_kans.conf['battChargeMin']):
